...
parser.add_argument('--data_dir', default='/home/junyang/experiment/re-id-qiang/train_set/train', type=str,
...
def train_model(model, criterion_part, criterion_tri, criterion_center, criterion_focal,optimizer, scheduler, num_epochs=60):
    ...
    for epoch in range(num_epochs):
        ...
        for data in dataloaders:
            ...
            loss = part_loss + tri_loss + glo_loss + focal_loss
...
pretrained_dict = torch.load('/home/junyang/experiment/re-id-resnext101/checkpoints/82.65/net_99.pth')
