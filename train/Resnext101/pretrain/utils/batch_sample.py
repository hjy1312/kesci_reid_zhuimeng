...
class BalancedBatchSampler(Sampler):
    ...
    def __iter__(self):
        ...
        for i in range(0,len(self.labels_set),self.n_classes):
            classes=self.labels_set[i:i+self.n_classes]
    ...
    def __len__(self):
        return len(self.labels_set) * self.n_samples // self.batch_size
    '''