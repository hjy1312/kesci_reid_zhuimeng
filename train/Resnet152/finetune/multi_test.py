...
def load_network1(network):
    ...
    save_path = os.path.join('/home/guoqiang/reid_competition/checkpoints/model3/net_59.pth')
...
def cal_cos_dis_2_matrix(a1, a2,b1,b2):
...
def cal_top_200_similar_ind(a1, a2,b1,b2):
    cos_mat = cal_cos_dis_2_matrix(a1, a2,b1,b2)
...
def load_data(path):
    ...
    return gal_fea1,gal_fea2, que_fea1, que_fea2,l_gal, l_que
...
def compute_result(path, save_path):
    gal_fea1, gal_fea2,que_fea1,que_fea2, l_gal, l_que = load_data(path)
    sim_ind = cal_top_200_similar_ind(que_fea1, que_fea2,gal_fea1,gal_fea2)
...
result = {'gallery_fea1': gallery_feature1.numpy(), 'gallery_fea2': gallery_feature2.numpy(),'gallery_path': g_path, 'query_fea1': query_feature1.numpy(),'query_fea2': query_feature2.numpy(),
          'query_path': q_path}
