...
parser.add_argument('--data_dir', default='/home/guoqiang/reid_competition/train_set/train', type=str,
...
def train_model(model, criterion_part, criterion_tri, criterion_center, criterion_focal,optimizer, scheduler, num_epochs=60):
    ...
    for epoch in range(num_epochs):
        ...
        for data in dataloaders:
            ...
            loss = part_loss + tri_loss + center_loss+focal_loss+glo_loss
        ...
        with open('/home/guoqiang/reid_competition/checkpoints/model/record.txt', 'a') as acc_file:
...
def save_network(network, epoch_label):
    ...
    save_path = os.path.join('./checkpoints/model2/', save_filename)
...
pretrained_dict = torch.load('./checkpoints/model2/152_81.66.pth')
...
# record
with open('/home/guoqiang/pack/checkpoints/model/record.txt', 'a') as acc_file:
